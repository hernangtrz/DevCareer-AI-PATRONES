...
exports.interviewTemplates = exports.getRandomInterviewCover = exports.interviewCovers = exports.feedbackSchema = void 0;
const zod_1 = require("zod");
exports.feedbackSchema = zod_1.z.object({
    totalScore: zod_1.z.number(),
    categoryScores: zod_1.z.array(zod_1.z.object({
        name: zod_1.z.string(),
...
const getRandomInterviewCover = () => {
    const randomIndex = Math.floor(Math.random() * exports.interviewCovers.length);
    return exports.interviewCovers[randomIndex];
};
exports.getRandomInterviewCover = getRandomInterviewCover;
exports.interviewTemplates = [
    {
